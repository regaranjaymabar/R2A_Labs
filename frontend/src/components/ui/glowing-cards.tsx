  ...
  return (
    ...
    >
      <div
        ref={containerRef}
        className={cn(
          "relative max-w-(--max-width) mx-auto ",
          "px-6 py-2"
        )}
      ...
      >
        <div
          className={cn(
            "flex items-center justify-center flex-wrap gap-(--gap)",
        ...
        {enableGlow && (
          ...
          >
            <div
              className={cn(
                "flex items-center justify-center flex-wrap gap-(--gap) max-w-(--max-width) center mx-auto",
                responsive && "flex-col sm:flex-row"
              )}
              style={{ padding: "var(--padding)" }} // String literal
            >
