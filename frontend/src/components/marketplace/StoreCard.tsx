...
// Type lokal (tidak import dari data/)
type StoreCardData = {
  id: number;
  name: string;
  address: string;
      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-wrap gap-6 mt-5 text-sm text-zinc-600">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-xs text-zinc-500">Jarak toko dari lokasi Anda</p>
                {store.distance !== null ? (
                  <p className="font-semibold text-black">
                    {store.distance.toFixed(1)} km
                  </p>
                ) : (
                  <p className="text-amber-600 font-medium">Aktifkan lokasi</p>
                )}
              </div>
            </div>
          </div>
        ...
        <div className="mt-auto pt-5">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="mt-auto inline-flex items-center justify-center rounded-full bg-black text-white px-6 py-3 hover:bg-zinc-800 transition"
          >
            Buka Google Maps →
          </a>
        </div>
