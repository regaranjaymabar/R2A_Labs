                ...
                cell: (info) => {
                    ...
                    return (
                        <div>
                            ...
                            <div className="text-xs text-gray-500 flex items-center gap-1 mt-0.5 font-semibold">
                    ...
                    return (
                        <div className="flex items-center justify-end gap-2">
                            <button
                                ...
                                disabled={isToggling}
                                className={`inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl font-bold text-xs border transition-all active:scale-95 shadow-xs cursor-pointer disabled:opacity-50 ${item.is_active
