        ...
        cell: (info) => {
          ...
          return (
            <div className="flex items-center gap-2.5">
              <span className="inline-flex items-center justify-center px-2.5 py-1 rounded-lg text-xs font-mono font-bold text-black">
                {code}
              </span>
              <div>
                ...
                <span className={`text-[11px] font-mono font-bold ${isBenefit ? "text-emerald-600" : "text-red-600"}`}>
        ...
        cell: (info) => {
          ...
          return (
            <div className="flex items-center gap-2">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-xl font-mono font-bold text-base bg-gray-200 text-black shadow-2xs">
