        ...
        <form onSubmit={handleSubmit} className="p-6 md:p-8 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className={isStoreAdmin ? "pointer-events-none opacity-80" : ""}>
                <InputSearchSelect
                  ...
                  placeholder={isStoresLoading ? "Memuat Toko..." : "Cari & Pilih Cabang Toko"}
          ...
          <div className="space-y-3 pt-4 border-t border-gray-100">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <button
                type="button"
                onClick={() => setValue("is_available", true, { shouldValidate: true })}
              ...
              >
                ...
                <div>
                  <span className={`block font-bold text-sm ${isAvailable ? "text-emerald-900" : "text-gray-700"}`}>
                    Tersedia
                  </span>
                </div>
              </button>
              ...
              <button
                type="button"
                onClick={() => setValue("is_available", false, { shouldValidate: true })}
                className={`p-4 rounded-2xl border-2 text-left transition-all flex items-start gap-3.5 cursor-pointer ${
                  !isAvailable
              ...
              >
                ...
                <div>
                  <span className={`block font-bold text-sm ${!isAvailable ? "text-red-900" : "text-gray-700"}`}>
                    Habis
                  </span>
                </div>
              </button>
          ...
          <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-200">
            ...
            <Button
              ...
              label={isSubmitting ? "Menyimpan..." : "Simpan Penempatan Stok"}
