...
const getRawSpecValue = (code: string, prod: any): string => {
  switch (code) {
    case "C1":
      return prod?.price || "-";
    case "C2":
    ...
    case "C5":
      return prod?.weight || "-";
    case "C6":
      return prod?.processor || "-";
    case "C7":
      return prod?.screenSize || prod?.screen_size || "-";
    case "C8":
      return prod?.releaseYear || prod?.release_year || "-";
    default:
      return "-";
  }
};
...
export function TabelProductWeightIndex({
  ...
  const renderCriteriaCell = (
    ...
    const rawVal = getRawSpecValue(code, group.product);
